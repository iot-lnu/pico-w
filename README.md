...
[N5_WiFi_Mosquitto_Node-Red_Test](./network-examples/N5_WiFi_Mosquitto_Node-Red_Test/) | ![](./network-examples/N5_WiFi_Mosquitto_Node-Red_Test/logo/mosquitto.jpg) Mosquitto ![](./network-examples/N5_WiFi_Mosquitto_Node-Red_Test/logo/node-red.jpg) Node-Red | A simple example shows how to send a random value as temperature to the MQTT broker